...
import top.nipuru.minegame.common.sheet.stBitmapMap
import top.nipuru.minegame.game.plugin
import top.nipuru.minegame.game.util.font.Bitmap
import top.nipuru.minegame.game.util.font.Font
import top.nipuru.minegame.game.util.font.FontRepository
import top.nipuru.minegame.game.util.font.resolver.BitmapResolver
import top.nipuru.minegame.game.util.font.resolver.FixedWidthResolver
import top.nipuru.minegame.game.util.font.resolver.SplitResolver
...
private fun bitmaps(): Map<String, Bitmap> {
    ...
    for (cfg in stBitmapMap.values) {
        ...
        val bitmap = Bitmap(cfg.configId, cfg.font, width, *chars.toTypedArray())
