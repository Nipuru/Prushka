...
import top.nipuru.prushka.server.common.sheet.stRewardAMap
import top.nipuru.prushka.server.common.sheet.stRewardPoolAMap
...
fun getRewardByPool(poolId: Int) : RewardInfo {
    val cfgs = top.nipuru.prushka.server.common.sheet.stRewardPoolAMap[poolId]!!
