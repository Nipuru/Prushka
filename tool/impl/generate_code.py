...
// Generated by tool
package top.nipuru.minegame.common.sheet
...
def generate_code():
    ...
    for table_name in Table.tables:
        ...
        sheet_path = '%s/minegame-common/src/main/kotlin/top/nipuru/minegame/common/sheet/%s.kt' % (Config.code_path, class_name)
    ...
    sheet_loader_path = '%s/minegame-common/src/main/kotlin/top/nipuru/minegame/common/sheet/Sheet.kt' % (Config.code_path)
